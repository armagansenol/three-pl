...
const StarrySky: React.FC<StarrySkyProps> = ({
  skyDomeRadius = 500.01,
  primaryColor = "#0d1a2f",
  secondaryColor = "#0f8682",
  noiseOffset = [100.01, 100.01, 100.01],
  starSize = 0.01,
  starDensity = 0.09,
  clusterStrength = 0.2,
  clusterSize = 0.2,
  ...
  return (
    <mesh>
      <sphereGeometry args={[skyDomeRadius, 20, 20]} />
      <shaderMaterial
        ref={materialRef}
        ...
        uniforms={{
          ...
          env_c1: { value: new THREE.Color(primaryColor) },
          env_c2: { value: new THREE.Color(secondaryColor) },
          noiseOffset: { value: new THREE.Vector3(...noiseOffset) },
          starSize: { value: starSize },
          starDensity: { value: starDensity },
          clusterStrength: { value: clusterStrength },
          clusterSize: { value: clusterSize },
          time: { value: 0 },
        }}
      />
    </mesh>
